// redux/services/messaging/messagingSlice.ts
...
const messagingSlice = createSlice({
  ...
  initialState,
  reducers: {
    setView: (state, action: PayloadAction<MessagingState["view"]>) => {
    ...
    // 🆕 Updated resetMessagingState to preserve projectId and set timestamp
