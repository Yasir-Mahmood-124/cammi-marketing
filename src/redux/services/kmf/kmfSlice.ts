// redux/services/kmf/kmfSlice.ts
...
const kmfSlice = createSlice({
  name: "kmf",
  initialState,
  reducers: {
    setView: (state, action: PayloadAction<KMFState["view"]>) => {
...
export default kmfSlice.reducer;